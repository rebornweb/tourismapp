...
app.get('/api/nearby/places', async (req, res) => {
  ...
  try {
    ...
    const response = await fetch(`${base_url}/location/nearby_search?latLong=${lat},${lng}&category=${category}&language=en&key=${process.env.NEXT_PUBLIC_TRIPADVISOR_API_KEY_ENV}`);
...
app.get('/api/location/details', async (req, res) => {
  ...
  try {
    ...
    const response = await fetch(`${base_url}/location/${location_Id}/details?language=en&key=${process.env.NEXT_PUBLIC_TRIPADVISOR_API_KEY_ENV}`);
    const data = await response.json();
    res.json(data); // Return the JSON data to the client
...
app.get('/api/reviews', async (req, res) => {
  ...
  try {
    ...
    const response = await fetch(`${base_url}/location/${location_Id}/reviews?language=en&key=${process.env.NEXT_PUBLIC_TRIPADVISOR_API_KEY_ENV}`);
    const data = await response.json();
    res.json(data); // Return the JSON data to the client
...
app.get('/api/photos', async (req, res) => {
  ...
  try {
    // Fetch reviews data from the TripAdvisor API
    const response = await fetch(`${base_url}/location/${location_Id}/photos?language=en&key=${process.env.NEXT_PUBLIC_TRIPADVISOR_API_KEY_ENV}`);
    const data = await response.json();
